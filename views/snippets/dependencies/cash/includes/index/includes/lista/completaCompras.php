...
<script src="views/snippets/dependencies/cash/includes/index/includes/lista/peticionCompra.js"></script>
...
?>
    ...
    <form style="padding: 12px 20px;" class="" style="display: block;" id="formularioprocesarCompra" method="POST" action="views/snippets/layout/pages/cajas/php/agregarPago.php">
...
?>
    ...
    <form style="padding: 12px 20px;" class="" style="display: block;" id="formularioprocesarCompra" method="POST" action="views/snippets/layout/pages/cajas/php/procesarCompra.php">

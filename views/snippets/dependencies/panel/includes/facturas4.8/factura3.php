        ...
        <div class="row">
            <div class="col-md-12">                
                  <?php $total=0; $pago = $datos['pago']; while($datos2 = mysqli_fetch_array($arrayBillDetail1)) { ?>
                    ...
                    <form action="detalles&id=0&dia=compra" method="GET" id="formulario">
                    			<div class="row">
                    				<div class="col-lg-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive m-t-40" style="clear: both;">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php $total=0; $i=1; while($datos2 = mysqli_fetch_array($arrayBillDetail3)) { ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="text-right">
                                    ...
                                    <form action="<?php URL ?>/irocket/views/snippets/layout/pages/cajas/php/imprimir_compra.php?fecha=<?php echo $fecha; ?>" method="POST">

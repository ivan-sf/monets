...
$atA = $modelMov->semActiveV($_GET['fecha']);
$atP = $modelMov->semPassiveV($_GET['fecha']);
$atA1 = $modelMov->semActive($_GET['fecha']);
$atP1 = $modelMov->semPassive($_GET['fecha']);

$totalA1 = 0;
while ($dataA1 = mysqli_fetch_array($atA1)) {
    $totalA1 += $dataA1['totalMoney'];
}
$totalP1 = 0;
while ($dataP1 = mysqli_fetch_array($atP1)) {
    $totalP1 += $dataP1['totalMoney'];
}
$totalA = 0;
...
$atDA = $modelMov->semActiveD($_GET['fecha']);
$atDP = $modelMov->semPassiveD($_GET['fecha']);
$totalDA = 0;
...
<div id="page-wrapper" style="min-height: 923px;">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                    	<div class="white-box">
                    		<form action="views/snippets/layout/pages/facturas/ventas/reportesemanal.php" method="GET" id="formulario">
                    			<div class="row">
                    					<div class="col-lg-4">
                    ...
                    <div class="col-md-6 col-lg-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <div id="morris-donut-chart-sem"></div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="white-box">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <h3><li class="text-right text-primary">$<span class="counter"><?php echo number_format($totalA1) ?></span></li></h3>
                            </ul>
                        </div>
                        <div class="white-box" style="margin-top: 20px">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <h3><li class="text-right text-danger">$<span class="counter"><?php echo number_format($totalP1) ?></span></li></h3><br>
                            </ul>
                        </div>
                    </div>
...
<script>
    ...
    function listar() {
    	var fecha = $("#fecha").val();
		var URL = "../../irocket/views/tables/reportes/venta/listar_facturas_semanal.php?fecha=" + fecha;
...
<script>
    ...
    function listar() {
        var fecha = $("#fecha").val();
        var URL = "../../irocket/views/tables/reportes/compra/listar_facturas_semanal.php?fecha=" + fecha;
        var datos = $("#formulario").serialize();

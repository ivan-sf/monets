...
$atA = $modelMov->yearActiveV($_GET['fecha']);
$atP = $modelMov->yearPassiveV($_GET['fecha']);
$totalA = 0;
...
$atDA = $modelMov->yearActiveD($_GET['fecha']);
$atDP = $modelMov->yearPassiveD($_GET['fecha']);
$totalDA = 0;
...
<div id="page-wrapper" style="min-height: 923px;">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                    	<div class="white-box">
                    		<form action="views/snippets/layout/pages/facturas/ventas/reporteanual.php" method="GET" id="formulario">
                    			<div class="row">
                    					<div class="col-lg-4">
                        ...
                        <?php 
$atA = $modelMov->yearActive($_GET['fecha']);
$atP = $modelMov->yearPassive($_GET['fecha']);
$totalA = 0;
while ($dataA = mysqli_fetch_array($atA)) {
    $totalA += $dataA['totalMoney'];
}
 ...
 ?>
                    ...
                    <div class="col-md-6 col-lg-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <div id="morris-donut-chart-Y"></div>
                        </div>
...
<script>
    ...
    function listar() {
    	var fecha = $("#fecha").val();
		var URL = "../../irocket/views/tables/reportes/venta/listar_facturas_anual.php?fecha=" + fecha;
...
<script>
    ...
    function listar() {
        var fecha = $("#fecha").val();
        var URL = "../../irocket/views/tables/reportes/compra/listar_facturas_anual.php?fecha=" + fecha;
        var datos = $("#formulario").serialize();

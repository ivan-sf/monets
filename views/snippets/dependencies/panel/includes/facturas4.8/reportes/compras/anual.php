...
<div id="page-wrapper" style="min-height: 923px;">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                    	<div class="white-box">
                    		<form action="views/snippets/layout/pages/facturas/compras/reporteanual.php" method="GET" id="formulario">
                    			<div class="row">
                    					<div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="white-box">
                                    ...
                                    <div class="text-right"> <span class="text-muted">Ingresos anuales</span>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="white-box">
                                    ...
                                    <div class="text-right"> <span class="text-muted">Gastos anuales</span>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="white-box">
                                    ...
                                    <div class="text-right"> <span class="text-muted">Balance anual</span>

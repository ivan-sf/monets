...
<div class="container-fluid">
    ...
    <br>
				...
				<div class="white-box">
					...
					<h1>Corregir datos de facturas</h1><br>
					<form action="" method="POST">
						<input type="hidden" value="" name="formProcessVenta">
						<input type="submit" value="Procesar facturas de venta">
					</form>

					<form action="" method="POST">
						<input type="hidden" value="" name="formProcessCompra">
						<input type="submit" value="Procesar facturas de compra">
					</form>
					<h1>Ingresar registros contables</h1><br>
					<form action="" method="POST">
						<input type="hidden" value="" name="formProcessNotasContablesC">
						<input type="submit" value="Procesar notas contables C">
					</form>

					<form action="" method="POST">
						<input type="hidden" value="" name="formProcessNotasContablesV">
						<input type="submit" value="Procesar notas contables V">
					</form>
					<h1>Ingresar cuentas</h1><br>
					<form action="" method="POST">
						<input type="hidden" value="" name="formProcessCuentas">
						<input type="submit" value="Procesar Cuentas C">
					</form>

					<form action="" method="POST">
						<input type="hidden" value="" name="formProcessRegConV">
						<input type="submit" value="Registros contables ventas">
					</form>
					<form action="" method="POST">
						<input type="hidden" value="" name="formProcessRegConC">
						<input type="submit" value="Registros contables compras">
					</form>

					<h1>Procesar PUC</h1><br>
					<form action="" method="POST">
						<input type="hidden" value="" name="procesarPUC">
						<input type="submit" value="Registros PUC">
					</form>

					<h1>Procesar PUC Details</h1><br>
					<form action="" method="POST">
						<input type="hidden" value="" name="procesarPUCD">
						<input type="submit" value="Registros PUC Details">
					</form>

					<h1>Procesar PUC's Auxiliares</h1><br>
					<form action="" method="POST">
						<input type="hidden" value="" name="procesarPUCD">
						<input type="submit" value="Registros PUC Details">
					</form>

					<h1>Procesar Usuarios</h1><br>
					<form action="" method="POST">
						<input type="hidden" value="" name="procesarUsuarios">
						<input type="submit" value="Procesar Usuarios">
					</form>
					<h1>Procesar DV</h1><br>
					<form action="" method="POST">
						<input type="hidden" value="" name="procesarDV">
						<input type="submit" value="Procesar DV">
					</form>
    ...
    columns:[
        {
            ...
            "render": function ( data, type, full, meta ) {
                ...
                return '<a href='+'http://localhost/irocket/contabilidad/puc/favoritos/agregar?'+codigo+' class=""></a>';
            }
        },
        {
            sortable: false,
            "render": function ( data, type, full, meta ) {
                var codigo = ""+full.codigo;
                return '<a href='+'http://localhost/irocket/contabilidad/puc/favoritos/agregar?'+codigo+' class="btn btn-success rolloverBtn" role="button">Agregar a favoritos</a>';
            }
        },
        {
            sortable: false,
            "render": function ( data, type, full, meta ) {
                var codigo = ""+full.codigo;
                return '<a href='+'http://localhost/irocket/contabilidad/puc/editar?'+codigo+' class="btn btn-warning rolloverBtn" role="button">Editar</a>';
            }
        },
        {
            sortable: false,

...
//echo $_SESSION['adminUser'];
    ...
    $comprobante = $_GET['id'];
    $arrayTC = $modelContabilidad->set("comprobante", $comprobante);
    $arrayTipoC = $modelContabilidad->arrayTipoC();
    $datosTC= mysqli_fetch_array($arrayTipoC);
...
<div class="container-fluid">
    ...
    <button class="btn m-btn--pill btn-badge"><a href="<?php echo URL; ?>contabilidad/crear?tipo=comprobante">Crear tipo de comprobante</a></button>
    <br>
    <br>

                	
				<div class="white-box">
					<center><h3 class="box-title">Eliminar tipo de comprobante</h3></center>
					<div class="row"><br>
												...
												<div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
																...
																<?php if (isset($_GET['success'])) {
																	...
																	if ($_GET['error'] == 2) {
																		...
																		echo "<div class='m-alert m-alert--icon m-alert--air m-alert--square alert alert-danger alert-dismissible fade show' role='alert' id='alertabien'>
																			...
																			No se puede eliminar el comprobante, ya esta en uso.</a>
																			</center>
																			</div>
																			<div class='m-alert__close'>
																			<button type='button' class='close' data-dismiss='alert' aria-label='Close'></button>
													...
													<div class="form-group m-form__group row" id="">
														<div class="col-lg-6">
																<b>Prefijo *</b><br>	
															<br>
                                                            <input type="hidden" name="idcomprobante" value="<?php echo $datosTC['idcomprobante']; ?>">
															<div class="m-input-icon" id="input1">
																
																<input value="<?php echo $datosTC['tipo']; ?>"  autofocus="" type="hidden" class="form-control m-input m-input--air m-input--pill" placeholder="Prefijo" name="tipo" id="tipo">
                                                            
                                                                <input value="<?php echo $datosTC['prefijo']; ?>" disabled autofocus="" type="text" class="form-control m-input m-input--air m-input--pill" placeholder="Prefijo" name="prefijoTC" id="prefijoTC">
															</div>
														</div>

																<input type="hidden" value="<?php echo $datosTC['numeracion']; ?>"class="form-control m-input m-input--air m-input--pill" placeholder="Numeracion" disabled name="numeracionTC" id="numeracionTC">
														...
														<div class="col-lg-6">
															...
															<div class="m-input-icon" id="input3">
																<input disabled value="<?php echo $datosTC['nombre']; ?>" autofocus type="text" class="form-control m-input m-input--air m-input--pill" placeholder="Nombre" name="" id="">
																<input value="<?php echo $datosTC['nombre']; ?>" autofocus type="hidden" class="form-control m-input m-input--air m-input--pill" placeholder="Nombre" name="nombreTC" id="nombreTC">
															</div>
														</div>
														...
														<div class="m-form__actions m-form__actions--solid">
															<div class="row">
																<div class="col-lg-12">
																	...
																	<center><button type="button" class="btn btn-block m-btn--square  btn-danger m-btn m-btn--custom m-btn--bolder m-btn--uppercase" id="botonCrear">
																		<h4 class="text-white">Eliminar</h4>
																	</button></center><br>
																</div>
                                ...
                                <table id="dt_contabilidad" class="table table-striped dataTable no-footer" role="grid" aria-describedby="myTable_info">
									...
									<tbody>
										<tr>
												...
												<th><?php echo $datosTC['numeracion']-1; ?></th>

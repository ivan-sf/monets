...
//echo $_SESSION['adminUser'];
	...
	$arrayVCod = $modelContabilidad->arrayComprobantes();
	$arrayV = $modelContabilidad->arrayVentas();
	$arrayVFE = $modelContabilidad->arrayVentasFE();
	$arrayC = $modelContabilidad->arrayCompras();
	$arrayCFE = $modelContabilidad->arrayComprasFE();
	$ventasRow=mysqli_num_rows($arrayV);
	$ventasFERow=mysqli_num_rows($arrayVFE);
	$comprasRow=mysqli_num_rows($arrayC);
	$comprasFERow=mysqli_num_rows($arrayCFE);
    	
    ///$array = $modelContabilidad->arrayCom();											
}else{
    header("location:" . URL);
}
													...
													<div class="form-group m-form__group row" id="">
														<div class="col-lg-6">
															...
															<div class="m-input-icon" id="input1">
																<input require autofocus="" type="text" class="form-control m-input m-input--air m-input--pill" placeholder="Prefijo" name="prefijoTC" id="prefijoTC">
															</div>
														</div>

																<input type="hidden" class="form-control m-input m-input--air m-input--pill" placeholder="Numeracion" value="1"name="numeracionTC" id="numeracionTC">
														...
														<div class="col-lg-6">
															...
															<div class="m-input-icon" id="input3">
																<input type="text" class="form-control m-input m-input--air m-input--pill" placeholder="Nombre" name="nombreTC" id="nombreTC">
															</div>
														</div>
                                ...
                                <table id="dt_contabilidad" class="table table-striped dataTable no-footer" role="grid" aria-describedby="myTable_info">
                                    <thead>
                                        <tr role="row">
                                            <th>Prefijo</th>
                                            <th>Nombre</th>
                                            <th>Numero de comprobantes</th>
                                            <th>Ver</th>
                                            <th>Editar</th>
                                            <th>Eliminar</th>
                                        </tr>
                                    </thead>
									<?php while($datosTC= mysqli_fetch_array($arrayVCod)){?> 
									<tbody>
										<tr>
												<th><?php echo $datosTC['prefijo']; ?></th>
												<th><?php echo strtoupper($datosTC['nombre']); ?></th>
												<?php 
												$tipo=$datosTC['tipo'];
												$sql = "SELECT * FROM notacontable WHERE tipoNotacontable=$tipo AND estadoNotacontable=1";
                                                $query = $con->returnConsulta($sql);
                                                $row = mysqli_num_rows($query); 
												?>
												<th><?php echo $row; ?></th>
												<th><a href="<?php echo URL ?>contabilidad/documentos?tipo=<?php echo $datosTC['tipo']; ?>" class="btn btn-info">Ver</a></th>
												<th><a href="<?php echo URL ?>contabilidad/editar?tipo=tipocomprobante&id=<?php echo $datosTC['idcomprobante']; ?>" class="btn btn-warning">Editar</a></th>
												<th><a href="<?php echo URL ?>contabilidad/eliminar?tipo=tipocomprobante&id=<?php echo $datosTC['idcomprobante']; ?>" class="btn btn-danger">Eliminar</a></th>
									...
									<tr>
											...
											<th><a href="<?php echo URL ?>contabilidad/documentos?tipo=1" class="btn btn-info">Ver</a></th>
											<th><button disabled href="<?php echo URL ?>contabilidad/editar?tipo=tipocomprobante&id=1" class="btn btn-warning">Editar</button></th>
											<th><button disabled href="<?php echo URL ?>contabilidad/eliminar?tipo=tipocomprobante&id=1" class="btn btn-danger">Eliminar</button></th>
										...
										<tr>
											...
											<th>
												FACTURAS DE VENTA ELECTRONICA
											</th>
											<th>
												<?php echo $ventasFERow ?>
											</th>
											<th><a href="<?php echo URL ?>contabilidad/documentos?tipo=5000" class="btn btn-info">Ver</a></th>
											<th><button disabled href="<?php echo URL ?>contabilidad/editar?tipo=tipocomprobante&id=5000" class="btn btn-warning">Editar</button></th>
											<th><button disabled href="<?php echo URL ?>contabilidad/eliminar?tipo=tipocomprobante&id=5000" class="btn btn-danger">Eliminar</button></th>
										...
										<tr>
											...
											<th><a href="<?php echo URL ?>contabilidad/documentos?tipo=2" class="btn btn-info">Ver</a></th>
											<th><button disabled href="<?php echo URL ?>contabilidad/editar?tipo=tipocomprobante&id=2" class="btn btn-warning">Editar</button></th>
											<th><button disabled href="<?php echo URL ?>contabilidad/eliminar?tipo=tipocomprobante&id=2" class="btn btn-danger">Eliminar</button></th>
										...
										<tr>
											...
											<th>
												FACTURAS DE COMPRA ELECTRONICA
											</th>
											<th>
												<?php echo $comprasFERow ?>
											</th>
											<th><a href="<?php echo URL ?>contabilidad/documentos?tipo=5001" class="btn btn-info">Ver</a></th>
											<th><button disabled href="<?php echo URL ?>contabilidad/editar?tipo=tipocomprobante&id=5001" class="btn btn-warning">Editar</button></th>
											<th><button disabled href="<?php echo URL ?>contabilidad/eliminar?tipo=tipocomprobante&id=5001" class="btn btn-danger">Eliminar</button></th>

    ...
    <br>
				...
				<div class="white-box">
                    ...
                    <div class="alert alert-danger" role="alert">
                        <center>NO ES POSIBLE ELIMINAR COMPROBANTES DE COMPRA O VENTA</center>
                    </div>
                    <?php } ?>
					<div class="row"><br>
                        ...
                        <div class="alert alert-warning" role="alert">
                            <center>¿SEGURO QUE DESEA ELIMINAR <?php echo $datosComprobante['tipoComprobante'] ?> # <?php echo $datosComprobante['comprobante'] ?>?</center>
                        ...
                        <input type="submit" value="ELIMINAR DOCUMENTO" class="btn btn-danger btn-block">
                        </form>

...
<div class="container-fluid">
    ...
    <br>
				...
				<div class="white-box">
					<center><h3 class="box-title">Editar tipo de comprobante</h3></center>
					<div class="row"><br>
													...
													<div class="form-group m-form__group row" id="">
														...
														<div class="col-lg-6">
															...
															<div class="m-input-icon" id="input3">
																<input value="<?php echo $datosTC['nombre']; ?>" autofocus type="text" class="form-control m-input m-input--air m-input--pill" placeholder="Nombre" name="nombreTC" id="nombreTC">
															</div>
														</div>

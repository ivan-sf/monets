...
<div class="container-fluid">
    ...
    <br>
				...
				<div class="white-box">
					<center><h3 class="box-title">Eliminar cuenta contable</h3></center>
					<div class="row"><br>
											...
											<div class="m-portlet__body">
												<div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
																...
																<?php if (isset($_GET['success'])) {
																	...
																	if ($_GET['error'] == 2) {
																		...
																		echo "<div class='m-alert m-alert--icon m-alert--air m-alert--square alert alert-danger alert-dismissible fade show' role='alert' id='alertabien'>
																			...
																			El codigo que intenta eliminar o uno de sus auxiliares esta siendo usado en comprobantes <b>imposible eliminar</b>.</a>
																			</center>
																			</div>
																			<div class='m-alert__close'>
																			<button type='button' class='close' data-dismiss='alert' aria-label='Close'></button>
													...
													<div class="form-group m-form__group row" id="">
														...
														<div class="col-lg-3">
															...
															<div class="m-input-icon" id="input2">
																<input disabled value="<?php echo $datosTC['nombre'];?> " type="text" class="form-control m-input m-input--air m-input--pill" placeholder="Nombre" name="" id="">
																<input value="<?php echo $datosTC['nombre'];?> " type="hidden" class="form-control m-input m-input--air m-input--pill" placeholder="Nombre" name="nombrePuc" id="nombrePuc">
															</div>
														</div>
														...
														<div class="col-lg-3">
															...
															<div class="m-input-icon" id="input3">
																<input type="text" disabled value="<?php echo $datosTC['detalle'];?> " class="form-control m-input m-input--air m-input--pill" placeholder="Detalle" name="" id="">
																<input type="hidden" value="<?php echo $datosTC['codigo'];?>" class="form-control m-input m-input--air m-input--pill" placeholder="Detalle" name="codigo" id="codigo">
																<input type="hidden" value="<?php echo $datosTC['detalle'];?> " class="form-control m-input m-input--air m-input--pill" placeholder="Detalle" name="detalle" id="detalle">
															</div>
														</div>
														...
														<div class="col-lg-3">
															<b>Base</b>
																...
																<br>
															<div class="m-input-icon" id="input3">
																<input disabled type="text" value="<?php echo $datosTC['base'];?> " class="form-control m-input m-input--air m-input--pill" placeholder="Base" name="" id="">
																<input type="hidden" value="<?php echo $datosTC['base'];?> " class="form-control m-input m-input--air m-input--pill" placeholder="Base" name="base" id="base">
															</div>
														</div>
													...
													<div class="col-lg-12">
														...
														<div class="m-input-icon" id="input3">
														<input disabled type="checkbox" id="coding" name="tercero" value="1">
														<label for="coding">Tercero</label>
														<?php }else{ ?>
														<div class="m-input-icon" id="input3">
														<input disabled checked type="checkbox" id="coding" name="tercero" value="1">
														<label for="coding">Tercero</label>
														<?php } ?>

														<?php if($datosTC['exogena']==""){ ?>
														<input disabled type="checkbox" id="music" name="exogena" value="1">
    													<label for="music">Exogena</label>
														</div>
														<?php }else{ ?>
														<input disabled checked type="checkbox" id="music" name="exogena" value="1">
    													<label for="music">Exogena</label>
														</div>
														<?php } ?>
															...
															<div class="row">
																<div class="col-lg-12">
																	...
																	<center><button type="button" class="btn btn-block m-btn--square  btn-danger m-btn m-btn--custom m-btn--bolder m-btn--uppercase" id="botonCrear">
																		<h4 class="text-white">Eliminar codigo</h4>
																	</button></center><br>
																</div>

...
$atA = $modelMov->sixActiveV($_GET['fecha']);
$atP = $modelMov->sixPassiveV($_GET['fecha']);
$totalA = 0;
...
$atDA = $modelMov->sixActiveD($_GET['fecha']);
$atDP = $modelMov->sixPassiveD($_GET['fecha']);
$totalDA = 0;
...
<div id="page-wrapper" style="min-height: 923px;">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                    	<div class="white-box">
                    		<form action="views/snippets/layout/pages/facturas/ventas/reportesemestral.php" method="GET" id="formulario">
                    			<div class="row">
                    					<div class="col-lg-4">
 ...
 ?>
                    ...
                    <div class="col-md-6 col-lg-6 col-xs-12">
                        <div class="white-box">
                            ...
                            <div id="morris-donut-chart-semestre"></div>
                        </div>

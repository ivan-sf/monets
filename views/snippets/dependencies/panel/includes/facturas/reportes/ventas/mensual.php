...
$listaDevoluciones = $modelMov->listaDevolucionesMes($_GET['fecha'],$_GET['fechaY']);
...
$atDA = $modelMov->daytimeActiveDMes($_GET['fecha'],$_GET['fechaY']);
$atDP = $modelMov->daytimePassiveDMes($_GET['fecha'],$_GET['fechaY']);
$totalA = 0;
...
WHERE
bills.typeBill=1 AND stateBillDetail=2 AND MONTH(bills.dateRegister)='$day' AND YEAR(bills.dateRegister)='$dayY' OR
bills.typeBill=2 AND stateBillDetail=2 AND MONTH(bills.dateRegister)='$day' AND YEAR(bills.dateRegister)='$dayY' OR
bills.typeBill=3 AND stateBillDetail=2 AND MONTH(bills.dateRegister)='$day' AND YEAR(bills.dateRegister)='$dayY'
";
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="white-box text-center bg-danger">
                                    ...
                                    <p class="text-white">Gasto total de compras por Remision</p>
                                </div>
                            </div>
                        ...
                        <table id="listar_inv2" class="table table-striped dataTable no-footer" role="grid" aria-describedby="myTable_info">
                            <h4>Informe de remisiones "salidas"</h4>
                        ...
                        <table id="listar_inv4" class="table table-striped dataTable no-footer" role="grid" aria-describedby="myTable_info">
                            <h4>Informe de remisiones "entradas"</h4>
...
<script>
        function listar() {
                ...
                var table = $("#listar_inv1").DataTable({
                    "ajax":{
                        "method":"GET",
                        "url": "../../irocket/views/tables/inventarios/informeMensualPos.php?mes="+mes+"&año="+año+"&año2=2020"
                    },
                    dom:"Bfrtlip",
                    columns:[
                    {"data":"idbills"},
...
<script>
        function listar() {
                ...
                var table = $("#listar_inv2").DataTable({
                    "ajax":{
                        "method":"GET",
                        "url": "../../irocket/views/tables/inventarios/informeMensualRem.php?mes="+mes+"&año="+año+"&año2=2020"
                    },
                    dom:"Bfrtlip",
                    columns:[
                    {"data":"idbills"},
...
<script>
        function listar() {
                ...
                var table = $("#listar_inv4").DataTable({
                    "ajax":{
                        "method":"GET",
                        "url": "../../irocket/views/tables/inventarios/informeMensualCRem.php?mes="+mes+"&año="+año+"&año2=2020"
                    },
                    dom:"Bfrtlip",
                    columns:[
                    {"data":"idbills"},

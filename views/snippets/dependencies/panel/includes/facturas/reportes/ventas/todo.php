...
<div id="page-wrapper" style="min-height: 923px;">
            <div class="container-fluid">
                ...
                <?php 
                    ...
                    $atA = $modelMov->alltimeActiveV();
                    $atDA = $modelMov->alltimeActiveD();
                    $atP = $modelMov->alltimePassiveV();
                    $atDP = $modelMov->alltimePassiveD();
                    $totalA = 0;
...
<script>        
    function listar() {
        var table = $("#dt_bills").DataTable({
            "ajax":{
                "method":"POST",
                "url": "../../irocket/views/tables/reportes/venta/listar_facturas.php"
            },
            dom:"Bfrtlip",
            columns:[
                {"data":"bills_idbills"},

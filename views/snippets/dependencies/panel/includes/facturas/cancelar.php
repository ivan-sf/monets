        ...
        <div class="row">
            <div class="col-md-12">                
                   <?php $total=0; $pago = $datos['pago']; while($datos2 = mysqli_fetch_array($arrayBillDetail1)) { ?>
                    ...
                    <div class="col-lg-12">
                        <div class="white-box">
                            <h3><b>Cancelar o Eliminar factura</b></h3><br>
                            <h4><center>¿Esta seguro de que desea eliminar la factura? Los cambios se veran reflejados en sus estados financieros.</center></h4><br>
                                    ...
                                    ?>
                                         ...
                                         <div class="row">
                                            <div class="col-lg-12 col-sm-4 col-xs-12">
                                                <center>Estado actual de la factura</center>
                                     ...
                                     <br>
                                            ...
                                            <input type="hidden" name="eliminar" value="<?php echo 1; ?>">

                                        <div class="row">
                                            <div class="col-lg-6 col-sm-4 col-xs-12">
                                                <button class="btn btn-block btn-success waves-effect waves-light" type="submit"><b>ELIMINAR FACTURA</b></button>
                                            </div>
                                            <div class="col-lg-6 col-sm-4 col-xs-12">
                                                <a href="<?php echo URL; ?>facturas/detalles?id=<?php echo $_GET['id']; ?>&detalles"><button class="btn btn-block btn-danger waves-effect waves-light" type="button"><b>CANCELAR</b></button></a>
                                            </div>
                                         </div>

                        ...
                        <div class="m-portlet__head-title col-lg-12">
                            <span class="m-portlet__head-icon m--hide">
                                ...
                                <?php if (isset($_GET['success_update'])) {
                                            ...
                                            Se eliminaron los datos correctamente en adelante no tendras disponible el proveedor en tus datos.
                                            </center>
                                            </div>
                                            <div class='m-alert__close'>
                                            <button type='button' class='close' data-dismiss='alert' aria-label='Close'></button>
                                            ...
                                            <strong>
                                                ...
                                                El proveedor al que intentas acceder ha sido eliminado
                                            </center>
                                                </div>
                                                <div class='m-alert__close'>
                                                <button type='button' class='close' data-dismiss='alert' aria-label='Close'></button>
...
<script>        
        function listar() {
            var table = $("#dt_empleados").DataTable({
                "ajax":{
                    "method":"POST",
                    "url": "../../irocket/views/tables/listar_proveedores.php"
                },
                dom:"Bfrtlip",
                columns:[
                    {"data":"userName"},

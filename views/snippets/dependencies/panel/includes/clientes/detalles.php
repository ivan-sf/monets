...
if ($datos1['stateBD'] == 1) {
    ...
    header("location:" . URL . "clientes?error=delete");
}
?>
<div id="page-wrapper" style="min-height: 953px;">
    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <button class="btn m-btn--pill btn-badge"><a href="<?php echo URL; ?>clientes/crear">Crear</a></button>
            <br>
            <br>
           ...
           <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-lg-8">
                <div class="white-box">
                        ...
                        <form method="POST" class="m-form m-form--fit m-form--label-align-right"  enctype="multipart/form-data" >
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-12 col-md-9 col-sm-12">
                                    ...
                                    <span class="m--font-">
                                        <small>Descripcion del cliente.</small>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="settings" aria-expanded="false">
                        <br>
                        <center> <div class="col-lg-12 alert alert-info"> Esta a punto de eliminar un cliente, recuerde que si realiza esta accion ya no tendra disponible este cliente en ningun modulo. </div></center>
                ...
                <div class="tab-pane active" id="messages" aria-expanded="false">
                    ...
                    <form method="POST" class="m-form m-form--fit m-form--label-align-right"  enctype="multipart/form-data" >
                                ...
                                <span class="m--font-">
                                    <small>Empresa a la que pertenece el cliente.</small>
                                </span>
                            </div>
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <span class="m-form__help">
                                    <span class="m--font-">
                                        <small>Nombres del cliente.</small>
                                    </span>
                                </span>
                            </div>
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <span class="m-form__help">
                                    <span class="m--font-">
                                        <small>Primer apellido del cliente.</small>
                                    </span>
                                </span>
                            </div>
            ...
            <div class="tab-pane" id="settings" aria-expanded="false">
                 <br>
                    ...
                    <br> 
                    <center><button class="btn m-btn--square btn-danger" alt="default" data-toggle="modal" data-target=".bs-modal-sm" class="model_img img-responsive">ELIMINAR CLIENTE</button></center>

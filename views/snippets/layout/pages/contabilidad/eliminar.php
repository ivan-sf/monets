...
<?php if($_GET['tipo']=='documento'){
            include "views/snippets/dependencies/panel/includes/contabilidad/puc/eliminarDocumento.php";        
    } ?>
    <?php if($_GET['tipo']=='tipocomprobante'){
            include "views/snippets/dependencies/panel/includes/contabilidad/puc/eliminarTipoComprobante.php";        
    } ?>
    <?php if($_GET['tipo']=='codigo'){
            include "views/snippets/dependencies/panel/includes/contabilidad/puc/eliminarCodigo.php";        
    } ?>

...
$array19= $con->query("SELECT * FROM bills INNER JOIN billdetails ON idbills=bills_idbills WHERE idbills='$idbills'  AND ivaPorcentaje=19");	
$iva19 = 0;
...
$array5= $con->query("SELECT * FROM bills INNER JOIN billdetails ON idbills=bills_idbills WHERE idbills='$idbills'  AND ivaPorcentaje=5");	
$iva5 = 0;
...
$array0= $con->query("SELECT * FROM bills INNER JOIN billdetails ON idbills=bills_idbills WHERE idbills='$idbills'  AND ivaPorcentaje=0 OR idbills='$idbills'  AND ivaPorcentaje=''");	
$iva0 = 0;
...
//RESOLUCION
//$printer->text("RESOL. DIAN 18764004378611 DE 18/09/2020" ."\n");
//$printer->text("PREFIJO RESOLUCION DIAN IN DEL:" ."\n");
//$printer->text("1 AL 50000 HABILITA:" ."\n\n");
$printer->setJustification(Printer::JUSTIFY_CENTER);
//FOOTER
...
$printer->text("COPIA DE REMISION" ."\n");

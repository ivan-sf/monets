...
$printer->text("REMISION COMPRA #: ". $id ."\n");
...
$printer->text("================================================"."\n");
$printer->text("NOMBRE  CANTIDAD  PRECIO UNIDAD  PRECIO TOTAL"."\n");
$printer->text("================================================"."\n");
...
while ($datos = mysqli_fetch_array($array2)) {
	...
	$printer->text(strtoupper($datos['nombre'] . "\n"));
	$printer->text(strtoupper("          ".$datos['cantidad'] . "   " . $datos['precioUnidad'] . "   " . $datos['precioTotal'] . "\n"));
}

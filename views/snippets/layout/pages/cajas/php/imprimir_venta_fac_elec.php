...
$printer->text("FACTURA ELECTRONICA #: ". $id ."\n");
...
$printer->text("ESTIMADO CLIENTE RECUERDE QUE LA FACTURA ELECTRONICA ES EMITIDA AL CORREO ELECTRONICO ESTE RECIBO ES VALDIO UNICAMENTE COMO COMPROBANTE" . "\n");
//RESOLUCION
...
$printer->text("COPIA COMPROBANTE FACTURA ELECTRONICA" ."\n");
